...
targets = [
    ...
    'app/src/main/java/com/simiely/adskip/float/FloatWindowManager.kt',
    'app/src/main/java/com/simiely/adskip/service/AdSkipAccessibilityService.kt',
    'app/src/main/java/com/simiely/adskip/service/KeepAliveService.kt',
    'app/src/main/java/com/simiely/adskip/ui/MainActivity.kt',
    'app/src/main/java/com/simiely/adskip/util/SecurePrefs.kt',
...
cm = api('POST', 'https://api.github.com/repos/Simiely/android-adskip/git/commits', {'message': 'revert: v1.0 core files', 'tree': new_tree['sha'], 'parents': [ref['object']['sha']]})
